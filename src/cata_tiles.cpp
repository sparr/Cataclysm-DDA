                               ...
                               const std::array<bool, 5> &invisible )
{
    ...
    if( t && !invisible[0] ) {
        ...
        int connect_group = 0;
        int rotate_group = 0;
        if( static_cast<int>( t.obj().connects( connect_group ) ) | t.obj().rotates( rotate_group ) ) {
    ...
    if( invisible[0] ? overridden : neighborhood_overridden ) {
        ...
        if( t2 ) {
            ...
            int connect_group = 0;
            int rotate_group = 0;
            if( static_cast<int>( t2.obj().connects( connect_group ) ) | t2.obj().rotates( rotate_group ) ) {
                                 ...
                                 const std::array<bool, 5> &invisible )
{
    ...
    if( f && !invisible[0] ) {
        ...
        int connect_group = 0;
        int rotate_group = 0;
        if( static_cast<int>( f.obj().connects( connect_group ) ) | f.obj().rotates( rotate_group ) ) {
